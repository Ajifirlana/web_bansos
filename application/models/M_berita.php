...
class M_berita extends CI_Model {
  ...
  function __construct(){
	...
	public function dtberita(){
			return $query = $this->db->query("SELECT * FROM tbl_berita ORDER BY id_berita desc");
    ...
    return $query = $this->db->query("SELECT * FROM tbl_berita ORDER BY id_berita DESC LIMIT 5");
